# -*- coding: utf-8 -*-
"""
Created on Tue Mar  9 00:54:14 2021
...
def prepare_args():
    ...
    parser.add_argument('-sfp', '--sourcefilepath', type=str, required=False)
    parser.add_argument('-tfp', '--targetfilepath', type=str, required=False)
    ...
    # Setting deafult path and filename (comment these if running from terminal)
    fname = 'fare'
    parser.set_defaults(sourcefilepath=f'D:/trip_{fname}/trip_{fname}_2.csv')
    parser.set_defaults(targetfilepath=f'D:/trip_{fname}_2.parquet')
    parsed = parser.parse_args()
